...
const products: Product[] = [
  ...
  },
  {
    ...
    image:
      "https://img.freepik.com/free-photo/3d-render-vs-company-metal-letter-logo-pen-tool-created-clipping-path-included-jpeg-easy-composite_460848-7192.jpg?ga=GA1.1.343461677.1733769822&semt=ais_hybrid",
    description: "Immersive sound for gaming enthusiasts.",
    salesCount: 950,
    rating: 4.7,
  },
  {
  ...
  },
  {
    ...
    image:
      "https://img.freepik.com/free-photo/3d-render-vs-company-metal-letter-logo-pen-tool-created-clipping-path-included-jpeg-easy-composite_460848-7192.jpg?ga=GA1.1.343461677.1733769822&semt=ais_hybrid",
    description: "Timeless jeans for a perfect fit.",
    salesCount: 650,
    rating: 4.5,
  },
  {
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-[#333333] relative tracking-tight drop-shadow-lg">
            Best <span className="text-[#FB7E11] inline-block">Sellers</span>
            <motion.span
          ...
          <p className="text-[#666666] text-lg max-w-2xl mx-auto font-medium">
            Shop the crowd favorites—top picks loved by thousands!
          </p>
        </motion.div>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="relative w-full h-72 overflow-hidden">
                ...
                {/* Best Seller Badge */}
                <motion.div
                  className="absolute top-4 left-4 bg-[#FB7E11] text-white px-4 py-1 rounded-full flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all duration-300"
              ...
              {/* Decorative Element */}
              <motion.div
                className="absolute -top-3 -right-3 w-16 h-16 bg-[#FB7E11]/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                animate={{
                  scale: [1, 1.3, 1],
                  rotate: [0, 360],
                }}
